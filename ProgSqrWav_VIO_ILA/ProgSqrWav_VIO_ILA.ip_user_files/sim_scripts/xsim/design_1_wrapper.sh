...
#
# Script generated by Vivado on Mon Oct 21 15:37:40 +0530 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1_wrapper xil_defaultlib.design_1_wrapper xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Universidad/Xilinx/Vivado/2024.1/data/xsim"
  fi
